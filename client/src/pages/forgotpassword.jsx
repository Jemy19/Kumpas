    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-screen">
        <form
          ...
          className="w-full max-w-sm p-8 space-y-6 bg-white rounded shadow-lg"
        >
          ...
          <Button
            type="submit"
            disabled={butloading}
            className={`w-full h-10 select-none${
              butloading
                ? "bg-gray-400 cursor-not-allowed translate-y-1 select-none"
                : ""
            }`}
          >
          ...
          {message && (
            <p
              className={`mt-4 text-sm select-none${
